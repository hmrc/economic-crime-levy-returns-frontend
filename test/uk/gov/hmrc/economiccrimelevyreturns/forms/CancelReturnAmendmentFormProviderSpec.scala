...
class CancelReturnAmendmentFormProviderSpec extends BooleanFieldBehaviours {
  val form = new CancelReturnAmendmentFormProvider()()

  "value" should {
    val fieldName   = "value"
    val requiredKey = "cancelReturnAmendment.error.required"
